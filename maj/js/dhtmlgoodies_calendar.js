...
var selectBoxRolloverBgColor = '#D2E3F3'; // Background color on drop down lists(rollover)
...
function createYearDiv()
{
	...
	var startYear = d.getFullYear()/1 - 18;
    var yearSpan = 10;
...
function writeTopBar()
{
	...
	if(Opera)leftDiv.style.width = '14px';
...
function getTopPos(inputObj)
{
  ...
  return (screen.availWidth-485)/2;
}
...
function getleftPos(inputObj)
{
  ...
  return (screen.availHeight-235)/2;
}
